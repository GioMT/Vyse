...
create table public.loans (
  ...
  payment_frequency text default 'monthly' not null check (payment_frequency in ('monthly', 'bi-monthly')),
  first_payment_day integer check (first_payment_day between 1 and 28),
  second_payment_day integer check (second_payment_day between 1 and 28),
